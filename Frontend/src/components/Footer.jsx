      ...
      <div className="container" style={{ padding: "40px 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40, marginBottom: 40 }}>
          ...
          <div>
            ...
            <h4 style={{ fontSize: "0.85rem", fontWeight: 700, color: "var(--pk-pink-dark)", marginBottom: 16, display: "flex", alignItems: "center", gap: 6 }}>
              <MapPin size={14} /> Địa chỉ:
            </h4>
            <div style={{ display: "flex", flexDirection: "column", gap: 14, fontSize: "0.8rem", color: "#555", lineHeight: 1.5 }}>
              <p><strong>Chi nhánh Q1:</strong> 123 Đường Hoa Hồng, Phường Bến Nghé, Quận 1, TP.HCM</p>
              <p><strong>Chi nhánh Tân Bình:</strong> 456 Âu Cơ, Phường 10, Quận Tân Bình, TP.HCM</p>
              <p><strong>Chi nhánh Gò Vấp:</strong> 789 Quang Trung, Phường 11, Quận Gò Vấp, TP.HCM</p>
            </div>
          ...
          {/* GIỜ MỞ CỬA */}
          <div>
            <h4 style={{ fontSize: "0.95rem", fontWeight: 700, color: "#1a1a1a", marginBottom: 16 }}>GIỜ MỞ CỬA</h4>
            <div style={{ fontSize: "0.85rem", color: "#555", marginBottom: 24 }}>
            ...
            <Link to="#" style={{ display: "inline-block", marginTop: 16, fontSize: "0.85rem", fontWeight: 700, color: "var(--pk-pink-dark)" }}>
              📍 HỆ THỐNG CỬA HÀNG
            </Link>
          </div>
        ...
        {/* Copyright */}
        <div style={{ borderTop: "1px solid rgba(232,88,122,0.2)", paddingTop: 24, fontSize: "0.75rem", color: "#666", lineHeight: 1.6 }}>
          <p>Thiên đường Mỹ phẩm Chính hãng giá tốt. Với hơn 100+ Thương hiệu đồng hành. Là chuỗi cửa hàng uy tín hàng đầu của các bạn trẻ tại TP.HCM.</p>
          <p>Công ty TNHH PinkyLab Cosmetics - Giấy phép kinh doanh số 0123456789, cấp ngày 01/01/2025 bởi Sở Kế hoạch và Đầu tư TP.HCM.</p>
        </div>
      </div>
    </footer>
  );
